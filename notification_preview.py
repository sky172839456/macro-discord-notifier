...
CHANNEL_PREVIEWS: tuple[dict[str, Any], ...] = (
    {
        ...
        "english_summary": "U.S. consumer prices rose 2.7% from a year earlier, compared with 2.9% previously.",
        "english_points": ["Actual: 2.7%.", "Previous: 2.9%.", "Revised previous: 2.8%."],
    ...
    },
    {
        ...
        "english_summary": "Bitget announced the spot listing of EXAMPLE/USDT.",
        "english_points": ["Trading pair: EXAMPLE/USDT.", "Trading opens on July 29 at 18:00 Taiwan time."],
    ...
    },
    {
        ...
        "english_summary": "A major exchange temporarily paused withdrawals on selected networks while investigating the issue.",
        "english_points": ["Selected withdrawals are temporarily unavailable.", "The investigation remains in progress."],
    ...
    },
    {
        ...
        "english_summary": "USDT traded below the configured USD peg warning threshold.",
        "english_points": ["Observed price: $0.9920.", "Warning threshold: $0.9950.", "Monitoring remains active."],
    ...
    },
    {
        ...
        "english_summary": "Bitcoin open interest increased rapidly while price and funding also moved higher.",
        "english_points": ["Price change: +2.1%.", "Open interest change: +11.8%.", "Funding rate: +0.0120%."],
    ...
    },
    {
        ...
        "english_summary": "The institution announced an expansion of its digital asset services.",
        "english_points": ["The service scope will expand.", "Launch regions have not yet been fully confirmed."],
    ...
    },
    {
        ...
        "english_summary": "OKX announced wallet maintenance affecting deposits and withdrawals on a selected network.",
        "english_points": ["Deposits and withdrawals may be affected.", "The recovery time is pending official confirmation."],
    ...
    },
    {
        ...
        "english_summary": "A regulator published an update to a digital asset ETF filing.",
        "english_points": ["The filing documents were updated.", "The update does not by itself mean final approval."],
...
def preview_embed(item: dict[str, Any], now: datetime) -> dict[str, Any]:
    ...
    return {
        ...
        "fields": standard_fields(
            ...
            english_points=item.get("english_points"),
