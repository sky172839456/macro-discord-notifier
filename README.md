...
`crypto_news_notifier.py` 建立獨立的高訊號加密新聞頻道，顯示繁體中文主標題並保留英文原標題與原文摘要，同時提供繁體中文分類式重點及可能影響。新聞分為資安、監管、ETF／機構、穩定幣、交易所、區塊鏈協議與市場結構；價格預測、業配、教學及重複報導會被排除。標題翻譯失敗時會安全退回英文，結果會快取 30 天。
